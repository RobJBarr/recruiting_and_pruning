...
M = 4000
kern = gpflow.kernels.RBF(lengthscales=71.3267242017265, variance=14939.014609234113)
...
lml_task2 = ScalarToTensorBoard("logs/scipy/conditional", lambda: m.elbo(), f"remove-elbo-{M}-bike")
monitor2 = Monitor(
...
plt.grid()
axs.set_title('ELBO of SVGP as Points are Removed: Bike Dataset')
...
plt.tight_layout()
fig.savefig(f"/vol/bitbucket/rjb19/recruiting_and_pruning/figs/svgp_remove_inducing_bike.png")
